...
# define optimizer
from settings_custom import joint_optimizer_lrs, joint_lr_step_size
...
from settings_custom import num_train_epochs, num_warm_epochs, push_start, push_epochs
...
for epoch in range(num_train_epochs):
    ...
    save.save_model_w_condition(model=ppnet, model_dir=model_dir, model_name=str(epoch) + 'nopush', accu=accu,
                                target_accu=settings_custom.required_accuracy, log=log)
        ...
        if prototype_activation_function != 'linear':
            ...
            for i in range(20):
                ...
                save.save_model_w_condition(model=ppnet, model_dir=model_dir, model_name=str(epoch) + '_' + str(i) + 'push', accu=accu,
                                            target_accu=settings_custom.required_accuracy, log=log)
    print(f'\ntotal epoch time: {time.time() - start_time_epoch}')
logclose()
