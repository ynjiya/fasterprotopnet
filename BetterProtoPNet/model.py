...
class PPNet(nn.Module):
    ...
    def prototype_distances(self, x):
        ...
        print('conv_features', time.perf_counter() - start_time)
        
        start_time = time.perf_counter()
        distances = self._l2_convolution(conv_features)
        torch.cuda.synchronize()
        print('_l2_convolution', time.perf_counter() - start_time)
        return distances
    ...
    def forward(self, x):
        ...
        torch.cuda.synchronize()
        print('prototype_distances', time.perf_counter() - start_time)
        '''
        ...
        torch.cuda.synchronize()
        print('min_distances max_pool2d', time.perf_counter() - start_time)
        start_time = time.perf_counter()
        prototype_activations = self.distance_2_similarity(min_distances)
        logits = self.last_layer(prototype_activations)
        torch.cuda.synchronize()
        print('logits last_layer', time.perf_counter() - start_time)
