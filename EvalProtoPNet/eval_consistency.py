...
parser.add_argument('--data_path', type=str, default='../BetterProtoPNet/datasets/cub200_cropped/')
...
parser.add_argument('--prototype_shape', nargs='+', type=int, default=[2000, 128, 1, 1])
